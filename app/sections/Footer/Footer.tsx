...
export default function Footer() {
	return (
		<div className="mt-10 py-5 px-3 border flex items-center justify-between bg-footer">
			<div>
				<span className="text-sm font-medium text-footer-label" role="label">Navigation :</span>
				<div className="mt-1.5 flex space-x-2 text-[.5rem] text-footer-link">
			...
			<p className="w-28 text-[.6rem] text-center text-footer-description tracking-widest" role="author-description">All Rights Reserved KDragon | 2021</p>
		</div>
	)
}